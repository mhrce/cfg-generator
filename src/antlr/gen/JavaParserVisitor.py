# Generated from /Users/a.kazor/PycharmProjects/java-visitor/grammar/JavaParser.g4 by ANTLR 4.13.1
from antlr4 import *
...
class JavaParserVisitor(ParseTreeVisitor):
    ...
    def visitUnqualifiedClassInstanceCreationExpression(self,
                                                        ctx: JavaParser.UnqualifiedClassInstanceCreationExpressionContext):
        return self.visitChildren(ctx)
    ...
    def visitArrayCreationExpressionWithoutInitializer(self,
                                                       ctx: JavaParser.ArrayCreationExpressionWithoutInitializerContext):
        return self.visitChildren(ctx)

    # Visit a parse tree produced by JavaParser#arrayCreationExpressionWithInitializer.
    def visitArrayCreationExpressionWithInitializer(self,
                                                    ctx: JavaParser.ArrayCreationExpressionWithInitializerContext):
        return self.visitChildren(ctx)
